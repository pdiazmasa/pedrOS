/** Iconos SVG reutilizables - estilo futurista, tamaño por className */
...
export function IconRestore({ className = 'w-5 h-5' }) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
...
export function IconNotes({ className = 'w-5 h-5' }) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
...
export function IconLoader({ className = 'w-8 h-8' }) {
  return (
